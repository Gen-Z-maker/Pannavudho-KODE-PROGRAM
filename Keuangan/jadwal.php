...
// Handle tambah jadwal dipindah ke jadwaltambah.php

// Handle hapus jadwal dipindah ke jadwalhapus.php

// Ambil produk untuk dropdown dipindah ke jadwaltambah.php
...
<a href="cetak_jadwal.php?nama=<?= urlencode($nama) ?>"
   class="btn btn-danger">
    <i class="fa fa-file-pdf"></i> Cetak PDF
</a>
                            <a href="jadwaltambah.php" type="button" class="btn btn-success">
                ...
                <div class="card-body">
                    <form class="row g-3" method="GET">
                        ...
                        <div class="col-md-6 d-flex align-items-end">
                            ...
                            <a href="jadwal.php" class="btn btn-secondary"><i class="fas fa-rotate me-1"></i>Reset</a>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <?php else: foreach ($jadwal_list as $row): ?>
                                    <tr>
                                        ...
                                        <td>
<a href="jadwaledit.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning me-1">
    <i class="fas fa-edit"></i>
</a>

<a href="jadwalhapus.php?delete=<?php echo $row['id']; ?>" 
